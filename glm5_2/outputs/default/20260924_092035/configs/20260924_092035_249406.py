...
eval=dict(
    partitioner=dict(
        out_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default/20260924_092035/results/',
...
infer=dict(
    partitioner=dict(
        out_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default/20260924_092035/predictions/',
        type='ais_bench.benchmark.partitioners.naive.NaivePartitioner'),
    runner=dict(
        debug=False,
        max_num_workers=1,
...
work_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default/20260924_092035'