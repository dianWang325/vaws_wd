cli_args=dict(
    ...
    search=False,
    summarizer=None,
    work_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default')
datasets=[
    dict(abbr='gsm8k',
        eval_cfg=dict(
...
eval=dict(
    partitioner=dict(
        out_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default/20260924_092258/results/',
...
infer=dict(
    partitioner=dict(
        out_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default/20260924_092258/predictions/',
        type='ais_bench.benchmark.partitioners.naive.NaivePartitioner'),
    runner=dict(
        debug=False,
        max_num_workers=1,
        ...
        type='ais_bench.benchmark.runners.local.LocalRunner'))
models=[
    dict(abbr='vllm-api-stream-chat',
        api_key='',
        attr='service',
        batch_size=2048,
        ...
        request_rate=0,
        retry=2,
        type='ais_bench.benchmark.models.api_models.vllm_custom_api_chat.VLLMCustomAPIChatStream',
        url=''),
    ]
summarizer=dict(
    summary_groups=[
...
work_dir='/home/w00985415/vaws_wd/glm5_2/outputs/default/20260924_092258'